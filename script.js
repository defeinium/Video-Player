...
function showPlayIcon() {
    playBtn.classList.replace('fa-pause', 'fa-play'); // To target CSS element
    playBtn.setAttribute('title', 'Play');
}
function togglePlay() {
    if (video.paused) {
        video.play();
        playBtn.classList.replace('fa-play', 'fa-pause'); // To target CSS element
...
function displayTime(time) {
    ...
    let seconds = Math.floor(time % 60); // anything that is >60, return that value (remainder)
